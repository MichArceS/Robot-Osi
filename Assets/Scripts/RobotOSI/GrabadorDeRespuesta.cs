...
public class GrabadorDeRespuesta : MonoBehaviour
{
    ...
    private void DetenerYProcesar()
    {
        ...
        if (!hablo)
        {
            Debug.LogWarning("No se detect� voz. No se subir� el audio.");
            return;
        }
    ...
    {
        Debug.Log("Esperando hasta 1 minuto por detecci�n de voz...");
        ...
        while (tiempoTranscurrido < tiempoMaximo)
        {
            ...
            foreach (float sample in buffer)
            {
                ...
                {
                    Debug.Log("Voz detectada. Iniciando grabaci�n real.");
                    habloUltimaVez = true;
        ...
        Debug.Log("No se detect� voz en 1 minuto.");
    }
